...
import { employees, sponsors } from '@/data/aboutData'; // Импорт данных сотрудников и спонсоров

import { reviews } from '@/data/doctorData'; // Импорт данных о докторах и отзывах

import Reviews from '../doctors/reviews'; // Импорт отзывов


const AboutUs: React.FC = () => {
 
  const doctorReviews = reviews[1]; // Отзывы о докторе
